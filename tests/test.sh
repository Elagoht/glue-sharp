...
$sharpglue examples/header.txt examples/data.txt examples/data1.txt -t -f "." -a center -s " | "  > tests/results/result2
$sharpglue examples/header.csv examples/data.csv examples/data1.txt -m > tests/results/result3
$sharpglue examples/header.txt examples/data.txt examples/data1.txt -H " --> " -s " - " > tests/results/result4
